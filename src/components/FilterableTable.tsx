                                ...
                                <tbody>
                                    {currentRows.map((row, index) => (
                                        <tr key={index}>
                                            {columns.map((col, idx) => (
                                                <td key={idx}>
                                                    {col.accessor.startsWith('data') // Verifica se a coluna é uma data
                                                        ? Service.formatDate((row as any)[col.accessor] instanceof Date 
                                                            ? (row as any)[col.accessor] 
                                                            : new Date((row as any)[col.accessor]))
